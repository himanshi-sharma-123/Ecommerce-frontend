...
function ProductForm() {
  ...
  const handleDelete = () => {
    ...
    dispatch(updateProductAsync(product)); // we are not actually deleting the product but actually making delete as true
  };
    ...
    <>
      <form
        ...
        onSubmit={handleSubmit((data) => {
          ...
          product.price = +product.price; //BY + WE CAN CONVERT THINGS INTO NUMERIC
